    ...
    <SafeAreaView style={tw`flex-1 bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100`}>
      ...
      <ScrollView contentContainerStyle={tw`flex-grow px-6 pb-24 pt-4`} showsVerticalScrollIndicator={false}>
        ...
        <View style={tw`flex-col gap-6 mb-8`}>
          {/* Card 1 (Visa) */}
          <View style={tw`w-full aspect-[1.58/1] rounded-2xl overflow-hidden shadow-lg bg-[#064e3b]`}>
          ...
          {/* Card 2 (Mastercard) */}
          <View style={tw`relative w-full aspect-[1.58/1] rounded-2xl overflow-hidden shadow-lg bg-[#312e81] opacity-60`}>
            {/* Abstract representations of gradient/textures */}
             <View style={tw`absolute inset-0 bg-black/40`} />
